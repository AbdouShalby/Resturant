                    ...
                    <div class="box-body">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="cat_id" class="form-control" id="category" required>
                                    ...
                                    <?php foreach ($menu_type as $key => $type): ?>
                                        <option data-type="<?= html_escape($type['type']) ;?>" <?= isset($data['cat_id']) && $data['cat_id']==$type['id']?"selected":"";?> <?= isset($cat_id) && $cat_id==md5($type['id'])?"selected":"";?> value="<?= $type['id'];?>"><?= $type['name_en'];?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group <?= $is_stock==1?"col-md-6":"col-md-12" ;?>">
                                <label for="title"><?= !empty(lang('title'))?lang('title'):"Title";?> <span class="error">English *</span></label>
                            ...
                            <div class="form-group <?= $is_stock==1?"col-md-6":"col-md-12" ;?>">
                                <label for="title"><?= !empty(lang('title'))?lang('title'):"Title";?> <span class="error">Arabic</span></label>
                                <input type="text" name="title_ar" id="title_ar" class="form-control" placeholder="<?= !empty(lang('item_name'))?lang('item_name'):"item name";?>" value="<?= !empty($data['title_ar'])?html_escape($data['title_ar']):set_value('title_ar'); ?>">
                            </div>
                            <div class="form-group <?= $is_stock==1?"col-md-6":"col-md-12" ;?>">
                                <label for="title"><?= !empty(lang('title'))?lang('title'):"Title";?> <span class="error">Uzbek</span></label>
                                <input type="text" name="title_uz" id="title_uz" class="form-control" placeholder="<?= !empty(lang('item_name'))?lang('item_name'):"item name";?>" value="<?= !empty($data['title_uz'])?html_escape($data['title_uz']):set_value('title_uz'); ?>">
                            </div>
                            <div class="form-group <?= $is_stock==1?"col-md-6":"col-md-12" ;?>">
                                <label for="title"><?= !empty(lang('title'))?lang('title'):"Title";?> <span class="error">Russian</span></label>
                                <input type="text" name="title_ru" id="title_ru" class="form-control" placeholder="<?= !empty(lang('item_name'))?lang('item_name'):"item name";?>" value="<?= !empty($data['title_ru'])?html_escape($data['title_ru']):set_value('title_ru'); ?>">
                            </div>
                            <div class="form-group <?= $is_stock==1?"col-md-6":"col-md-12" ;?>">
                                <label for="title"><?= !empty(lang('title'))?lang('title'):"Title";?> <span class="error">Chinese</span></label>
                                <input type="text" name="title_ch" id="title_ch" class="form-control" placeholder="<?= !empty(lang('item_name'))?lang('item_name'):"item name";?>" value="<?= !empty($data['title_ch'])?html_escape($data['title_ch']):set_value('title_ch'); ?>">
                            </div>
                            <div class="form-group <?= $is_stock==1?"col-md-6":"col-md-12" ;?>">
                                <label for="title"><?= !empty(lang('title'))?lang('title'):"Title";?> <span class="error">French</span></label>
                                <input type="text" name="title_fr" id="title_fr" class="form-control" placeholder="<?= !empty(lang('item_name'))?lang('item_name'):"item name";?>" value="<?= !empty($data['title_fr'])?html_escape($data['title_fr']):set_value('title_fr'); ?>">
                            </div>
                            <div class="form-group <?= $is_stock==1?"col-md-6":"col-md-12" ;?>">
                                <label for="title"><?= !empty(lang('title'))?lang('title'):"Title";?> <span class="error">Portuguese</span></label>
                                <input type="text" name="title_po" id="title_po" class="form-control" placeholder="<?= !empty(lang('item_name'))?lang('item_name'):"item name";?>" value="<?= !empty($data['title_po'])?html_escape($data['title_po']):set_value('title_po'); ?>">
                            </div>
                            <div class="form-group <?= $is_stock==1?"col-md-6":"col-md-12" ;?>">
                                <label for="title"><?= !empty(lang('title'))?lang('title'):"Title";?> <span class="error">Hindi</span></label>
                                <input type="text" name="title_hi" id="title_hi" class="form-control" placeholder="<?= !empty(lang('item_name'))?lang('item_name'):"item name";?>" value="<?= !empty($data['title_hi'])?html_escape($data['title_hi']):set_value('title_hi'); ?>">
                            </div>
                            <?php if( $is_stock==1): ?>
                                <div class="form-group <?= $is_stock==1?"col-md-6":"col-md-12" ;?>">
                        ...
                        <div class="row">
                            <div class=" form-group col-md-12">
                                <label><?= !empty(lang('small_description'))?lang('small_description'):"small description";?> <span class="error">English *</span></label>
                            ...
                            <div class=" form-group col-md-12">
                                <label><?= !empty(lang('small_description'))?lang('small_description'):"small description";?> <span class="error">Arabic</span></label>
                                <textarea name="overview_ar" id="" cols="5" rows="5" class="form-control"><?= !empty($data['overview_ar'])?html_escape($data['overview_ar']):set_value('overview_ar'); ?></textarea>
                            </div>
                            <div class=" form-group col-md-12">
                                <label><?= !empty(lang('small_description'))?lang('small_description'):"small description";?> <span class="error">Uzbek</span></label>
                                <textarea name="overview_uz" id="" cols="5" rows="5" class="form-control"><?= !empty($data['overview_uz'])?html_escape($data['overview_uz']):set_value('overview_uz'); ?></textarea>
                            </div>
                            <div class=" form-group col-md-12">
                                <label><?= !empty(lang('small_description'))?lang('small_description'):"small description";?> <span class="error">Russian</span></label>
                                <textarea name="overview_ru" id="" cols="5" rows="5" class="form-control"><?= !empty($data['overview_ru'])?html_escape($data['overview_ru']):set_value('overview_ru'); ?></textarea>
                            </div>
                            <div class=" form-group col-md-12">
                                <label><?= !empty(lang('small_description'))?lang('small_description'):"small description";?> <span class="error">Chinese</span></label>
                                <textarea name="overview_ch" id="" cols="5" rows="5" class="form-control"><?= !empty($data['overview_ch'])?html_escape($data['overview_ch']):set_value('overview_ch'); ?></textarea>
                            </div>
                            <div class=" form-group col-md-12">
                                <label><?= !empty(lang('small_description'))?lang('small_description'):"small description";?> <span class="error">French</span></label>
                                <textarea name="overview_fr" id="" cols="5" rows="5" class="form-control"><?= !empty($data['overview_fr'])?html_escape($data['overview_fr']):set_value('overview_fr'); ?></textarea>
                            </div>
                            <div class=" form-group col-md-12">
                                <label><?= !empty(lang('small_description'))?lang('small_description'):"small description";?> <span class="error">Portuguese</span></label>
                                <textarea name="overview_po" id="" cols="5" rows="5" class="form-control"><?= !empty($data['overview_po'])?html_escape($data['overview_po']):set_value('overview_po'); ?></textarea>
                            </div>
                            <div class=" form-group col-md-12">
                                <label><?= !empty(lang('small_description'))?lang('small_description'):"small description";?> <span class="error">Hindi</span></label>
                                <textarea name="overview_hi" id="" cols="5" rows="5" class="form-control"><?= !empty($data['overview_hi'])?html_escape($data['overview_hi']):set_value('overview_hi'); ?></textarea>
                            </div>
