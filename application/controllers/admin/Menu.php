...
class Menu extends MY_Controller {
	...
	**/
    public function add_items(){
        ...
        $this->form_validation->set_rules('title', 'Title English', 'trim|required|xss_clean');
        $this->form_validation->set_rules('title_ar', 'Title Arabic', 'trim|xss_clean');
        $this->form_validation->set_rules('title_uz', 'Title Uzbek', 'trim|xss_clean');
        $this->form_validation->set_rules('title_ru', 'Title Russian', 'trim|xss_clean');
        $this->form_validation->set_rules('title_ch', 'Title Chinese', 'trim|xss_clean');
        $this->form_validation->set_rules('title_fr', 'Title French', 'trim|xss_clean');
        $this->form_validation->set_rules('title_po', 'Title Portuguese', 'trim|xss_clean');
        $this->form_validation->set_rules('title_hi', 'Title Hindi', 'trim|xss_clean');
        $this->form_validation->set_rules('overview', 'Small Description English', 'trim|required|xss_clean');
        $this->form_validation->set_rules('overview_ar', 'Small Description Arabic', 'trim|xss_clean');
        $this->form_validation->set_rules('overview_uz', 'Small Description Uzbek', 'trim|xss_clean');
        $this->form_validation->set_rules('overview_ru', 'Small Description Russian', 'trim|xss_clean');
        $this->form_validation->set_rules('overview_ch', 'Small Description Chinese', 'trim|xss_clean');
        $this->form_validation->set_rules('overview_fr', 'Small Description French', 'trim|xss_clean');
        $this->form_validation->set_rules('overview_po', 'Small Description Portuguese', 'trim|xss_clean');
        $this->form_validation->set_rules('overview_hi', 'Small Description Hindi', 'trim|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($check==1):
                ...
                $data = array(
                    ...
                    'title_uz' => $this->input->post('title_uz',true),
                    'title_ru' => $this->input->post('title_ru',true),
                    'title_ch' => $this->input->post('title_ch',true),
                    'title_fr' => $this->input->post('title_fr',true),
                    'title_po' => $this->input->post('title_po',true),
                    ...
                    'overview_ar' => $this->input->post('overview_ar'),
                    'overview_uz' => $this->input->post('overview_uz'),
                    'overview_ru' => $this->input->post('overview_ru'),
                    'overview_ch' => $this->input->post('overview_ch'),
                    'overview_fr' => $this->input->post('overview_fr'),
                    'overview_po' => $this->input->post('overview_po'),
                    'overview_hi' => $this->input->post('overview_hi'),
	...
	**/
    public function add_category(){
        ...
        $this->form_validation->set_rules('name_uz', 'Name Uzbek', 'trim|xss_clean');
        $this->form_validation->set_rules('name_ru', 'Name Russian', 'trim|xss_clean');
        $this->form_validation->set_rules('name_ch', 'Name Chinese', 'trim|xss_clean');
        $this->form_validation->set_rules('name_fr', 'Name French', 'trim|xss_clean');
        $this->form_validation->set_rules('name_po', 'Name Portuguese', 'trim|xss_clean');
        $this->form_validation->set_rules('name_hi', 'Name Hindi', 'trim|xss_clean');
        if ($this->form_validation->run() == FALSE) {
            $this->session->set_flashdata('error', validation_errors());
            ...
            $data = array(
                ...
                'name_ar' => $this->input->post('name_ar',true),
                'name_uz' => $this->input->post('name_uz',true),
                'name_ru' => $this->input->post('name_ru',true),
                'name_ch' => $this->input->post('name_ch',true),
                'name_fr' => $this->input->post('name_fr',true),
                'name_po' => $this->input->post('name_po',true),
                'name_hi' => $this->input->post('name_hi',true),
